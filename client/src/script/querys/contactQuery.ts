import type {ContactDocument, ContactInput, ContactUpdate} from "../../../../database/interface/contactInterface"
...
export async function getContactById(id:string):Promise<ContactDocument>{
    ...
    try{
        const res = await fetch(`/api/contact/getcontactbyid/${id}`,{
            method:"GET",
            headers:{
                "Content-Type":"application/json"
            },
...
export async function getContactsByOwnerUid(uid:string):Promise<ContactDocument>{
    ...
    try{
        const res = await fetch(`/api/contact/getcontactbyid/${uid}`,{
            method:"GET",
            headers:{
                "Content-Type":"application/json"
            },
